    ...
    <div class='layout'>
      ...
      <div class='content'>
        <div class='content-header'>
          <div class='content-title' data-testid="page-title"> Envoyer une note de frais </div>
        </div>
        <div class="form-newbill-container content-inner">
          <form data-testid="form-new-bill">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="col-half">
                  <button type="submit" id='btn-send-bill' data-testid="btn-send" class="btn btn-primary">Envoyer</button>
                </div>
              </div>
            </div>
          </form>
